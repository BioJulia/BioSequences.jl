@testset "Approximate" begin
    ...
    @testset "forward" begin
        ...
        @test findnext(ApproximateSearchQuery(dna"ACG", 3), seq, 1) === nothing #1:0
        @test findnext(ApproximateSearchQuery(dna"ACG", 4), seq, 1) === nothing #1:0
    end
    ...
    @testset "backward" begin
        ...
        @test findprev(ApproximateSearchQuery(dna"ACG", 3), seq, 7) === nothing #7:6
        @test findprev(ApproximateSearchQuery(dna"ACG", 4), seq, 7) === nothing #7:6
    end
end
