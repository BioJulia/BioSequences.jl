...
function kmerminhash!(::Type{DNAKmer{k}}, seq::GeneralSequence, s::Integer, kmerhashes::Vector{UInt64}) where {k}
...
"""
function minhash(seq::GeneralSequence, k::Integer, s::Integer)
...
function minhash(seqs::Vector{T}, k::Integer, s::Integer) where {T<:GeneralSequence}
    kmerhashes = UInt64[]
    for seq in seqs
